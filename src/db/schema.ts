...
export const selectUserSchema = z.object({
    ...
    username: z.string(),
    email: z.string(),
    roles: z.array(z.instanceof(mongoose.Types.ObjectId)).optional().nullable(),
    locale: z.string().optional().nullable(),
    timezone: z.string().optional().nullable(),
    verifiedEmail: z.boolean(),
    verifiedPhone: z.boolean(),
    authType: z.string(),
    idpClient: z.string().optional().nullable(),
    idpMetadata: z.string().optional().nullable(),
    idpSub: z.string().optional().nullable(),
    createdAt: z.instanceof(Date).optional(),
    updatedAt: z.instanceof(Date).optional(),
});
